...
public class ProjectPage extends BasePage {
    ...
    List<String> getVersionAttributes() {
        ...
        WebElement versionNumber = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[.='TestVersion']")));
        ...
        WebElement date = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//time[.='21/Jan/20']")));
